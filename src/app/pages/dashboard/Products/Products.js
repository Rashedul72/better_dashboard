        ...
        <table className="w-full min-w-max divide-y divide-black">
          <thead className="bg-blue-100 items-center">
            <tr>
              ...
              <th className="p-3 font-semibold text-sm uppercase text-gray-800">Picks</th>
              <th className="p-3 font-semibold text-sm uppercase text-gray-800">Actions</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-black">
            {currentProducts.map((product, index) => (
              <tr key={product._id} className="hover:bg-gray-100">
                ...
                <td className="p-3 text-sm text-center text-gray-800">{product.Pick}</td>
                <td className="p-3 text-sm text-center text-gray-800">
                  <button onClick={() => handleEditClick(product)} className="btn btn-sm btn-primary mr-2">
                    <FaEdit />
                  </button>
